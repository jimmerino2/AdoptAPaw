        ...
        <div class="flex-grow p-2">
            ...
            <div class="border border-black my-2" :class="{'grid grid-cols-7 items-top p-4': width >= 768}">
                <div :class="{'col-span-3 flex flex-row': width >= 768, 'flex flex-col items-start p-2 w-full':width <768}">
                    ...
                    <div class="flex-grow text-md" :class="{'border border-black w-[100%] group relative': width<768, 'flex-grow text-md': width>=768}">
                ...
                <div class="bg-zinc-200 col-span-4 rounded-lg mx-4 px-10 flex items-center justify-center flex-col my-4">
