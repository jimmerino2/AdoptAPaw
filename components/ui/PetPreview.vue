...
import HoverCard from './hover-card/HoverCard.vue';
import HoverCardContent from './hover-card/HoverCardContent.vue';
import HoverCardTrigger from './hover-card/HoverCardTrigger.vue';
</script>

<template>
    <NuxtLink to="/petDetails">
        <HoverCard>
            <HoverCardTrigger>
                <div class="border border-black rounded-md w-fit h-fit pb-4">
                    <img src="" alt="pet_image" class="bg-slate-100 size-[13rem] rounded-md">
