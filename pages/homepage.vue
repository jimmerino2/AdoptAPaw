...
<template>
  ...
  <div
    ...
    :class="{ 'max-h-[350px] border-b-8 border-orange-700': width >= 900 }"
  >
    ...
    >
      <div class="text-5xl p-2 pt-12 z-20 font-bold">Adopt Today</div>
      <div class="text-2xl p-2 text-center z-20 font-bold">
    ...
    >
      ...
      >
        <div
          class="flex m-3 items-center justify-center bg-orange-50 text-orange-700 shadow-2xl flex-col text-xl font-bold rounded-2xl ease-in duration-100 transform hover:scale-105 shadow-lg hover:shadow-2xl"
          :class="{
  ...
  <!-- About Us -->
  <div class="scaling bg-orange-100 pt-20 flex flex-col items-center">
